...
let showAllCitiesInformation = function() {
	FirstCity.info();
	SecondCity.info(); 
	ThirdCity.info();
	FourdCity.info();
...
for ( let kay in FirstCity) {
	ThirdCity[kay] = FirstCity[kay];
}
FourdCity = Object.assign({}, SecondCity);
ThirdCity.city_name = 'Miass';
ThirdCity.foundation_ear = 1773;
FourdCity.city_name = 'Orck';
FourdCity.foundation_ear = 1735;
		//вывод на консоль
